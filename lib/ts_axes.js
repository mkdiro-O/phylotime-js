 ...
 */
export function create_axes(svg, xScale, yScale, height) {
  svg.append("g")
    .attr("class", "x-axis")
 ...
 * @param {string} yLabel
 */
export function create_axis_labels(svg, width, height, xLabel, yLabel) {
  svg.append("text")
 ...
 * @param {string} title
 */
export function create_title(svg, width, title) {
  svg.append("text")
