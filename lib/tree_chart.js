...
import { createTreeSVG, defaultTreeOpts } from "./tree_setup.js";
...
export function initTree(
  ...
  svg.on("click", ev => {
    ...
    if (ix !== undefined && ix !== -1) {
      const f = tree.descendants()[ix];
      toggle_node(f);
      d3.tree().size([width, height - 20])(tree);
